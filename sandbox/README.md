...
<!--autoload_cluster=.-->
- [ ] `@user_001 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [aula vetores](user_001/README.md)
- [ ] `@user_002 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [dontpad tamarindo](user_002/README.md)
